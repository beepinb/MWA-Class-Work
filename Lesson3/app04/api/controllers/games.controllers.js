...
_renGeoQuery=function(req,res,offset,count){
...
module.exports.getAll = function (req, res) {
    ...
    if (response.status !== 200) {
        ...
        if(req.query && req.query.lat && req.query.lng){
            _renGeoQuery(req,res,offset,count);
            return;
        }
...
_replaceCallbackPartial = function (err, game, req, res, response) {
    if (err) {
        console.log("Error reading games");
        response.status = 500;
        response.message = err;
        ...
        if (game) {
            console.log("Inside _replaceCallbackPartial");
            console.log("Game Found");
            //res.status(200).json(game);
            //do update
...
// _updatePartial = function (req, res) {
//     const response = {
//         status: 200,
//         message: {}
//     };
...
module.exports.partialUpdate = function (req, res) {
    console.log("Full update one game controller");
    _updateOne(req, res,_replaceCallbackPartial);
